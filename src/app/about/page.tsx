  ...
  return (
    <PublicShell>
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-orange-500/10 via-muted/30 to-background py-24 sm:py-32">
        ...
        <Reveal className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
      ...
      <div className="border-y border-border bg-card py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <Reveal delay={0} className="space-y-1">
            ...
            <Reveal delay={100} className="space-y-1">
            ...
            <Reveal delay={300} className="space-y-1">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <Reveal delay={0} className="h-full">
            <div className="flex flex-col items-center text-center p-6 bg-card border border-border rounded-2xl hover:shadow-md transition-shadow h-full">
      ...
      {/* Narrative Section */}
      <Reveal className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      {/* CTA Section */}
      <Reveal animation="scale-in" className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-16 sm:py-24">
