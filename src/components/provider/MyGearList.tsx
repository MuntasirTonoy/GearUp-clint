                  ...
                  <div className="flex items-center gap-3">
                    {gear.images && gear.images.length > 0 ? (
                      ...
                      <img
                        src={gear.images[0]}
                        alt={gear.name}
                        className="h-12 w-12 rounded-md object-cover flex-shrink-0 border border-border bg-muted"
                      />
                    ) : (
                      <div className="h-12 w-12 rounded-md border border-border bg-muted flex items-center justify-center flex-shrink-0 text-muted-foreground text-[10px]">
                        No Img
                      </div>
                    )}
                    <div>
